    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-[#0F172A] mb-4">Choose Your Plan</h1>
          <p className="text-lg text-[#64748B]600">
            Get access to quality trade jobs and grow your business
          </p>
          
          {isFoundingMember && (
            <div className="mt-4 inline-block bg-[#F59E0B]/10 text-yellow-800 px-4 py-2 rounded-full text-sm font-medium">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                {plan.popular && (
                  <div className="bg-[#0F172A] text-white text-xs font-medium px-3 py-1 rounded-full inline-block mb-4">
                    MOST POPULAR
                  </div>
                )}
                ...
                <div className="mt-2 mb-4">
                  ...
                  <span className="text-[#64748B]500">{plan.period}</span>
                </div>
                <p className="text-sm text-[#64748B]600 mb-6">{plan.description}</p>

                <ul className="space-y-3 mb-6">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm">
                      <span className="text-green-600">✓</span>
                      <span className="text-[#64748B]700">{feature}</span>
                    </li>
                  ))}
                </ul>
                ...
                <button
                  className={`w-full py-3 rounded-xl font-medium ${
                    isCurrentPlan
                      ? 'bg-gray-100 text-[#64748B]400 cursor-default'
                      : plan.popular
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-[#0F172A] mb-2">Can I cancel anytime?</h4>
              <p className="text-sm text-[#64748B]600">Yes, you can cancel your subscription at any time. You'll keep access until the end of your billing period.</p>
            </div>
            <div>
              <h4 className="font-medium text-[#0F172A] mb-2">What counts as an "interested response"?</h4>
              <p className="text-sm text-[#64748B]600">When you express interest in a job and the homeowner views your profile, that counts as one interested response.</p>
            </div>
            <div>
              <h4 className="font-medium text-[#0F172A] mb-2">Can I upgrade or downgrade?</h4>
              <p className="text-sm text-[#64748B]600">Yes, changes to your plan take effect at the start of your next billing cycle.</p>
            </div>
            <div>
              <h4 className="font-medium text-[#0F172A] mb-2">What payment methods do you accept?</h4>
              <p className="text-sm text-[#64748B]600">We accept all major credit cards through Stripe.</p>
            </div>
          </div>
        </div>
      </main>
