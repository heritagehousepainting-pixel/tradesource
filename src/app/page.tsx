    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link href="/homeowner/signup" className="border-2 border-slate-900 text-black px-6 py-3 rounded-lg text-lg hover:bg-gray-50">
              Post a Project
            </Link>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <h3 className="text-2xl font-bold text-center mb-12 text-black">How It Works</h3>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold text-black">1</div>
              <h4 className="font-semibold mb-2 text-black">Request Access</h4>
              <p className="text-black">Contractors apply and get verified. Homeowners sign up free.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold text-black">2</div>
              <h4 className="font-semibold mb-2 text-black">Post or Browse Jobs</h4>
              <p className="text-black">Post overflow work or find jobs in your trade and area.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold text-black">3</div>
              <h4 className="font-semibold mb-2 text-black">Connect & Get Work</h4>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <h3 className="text-2xl font-bold mb-6 text-black">Why TradeSource Works</h3>
