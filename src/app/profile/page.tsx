...
function VerificationSection({ profile, externalReviews, onUpdate }: { profile: UserProfile; externalReviews?: string; onUpdate: () => void }) {
  ...
  if (isFullyVerified) {
    return (
      <div className="border border-gray-200 rounded-xl p-2 md:p-2 bg-green-50 border-green-200">
        <h2 className="text-sm font-bold mb-2 text-green-800">✅ Verification Complete</h2>
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-2 md:p-2">
      <h2 className="text-sm font-bold mb-2">📋 Verification Requirements</h2>
      <p className="text-sm mb-2 text-[#64748B]600">
        Complete all 6 requirements and submit together for admin review. No partial submissions allowed.
      </p>

      {/* Status Messages */}
      {showPending && (
        <div className="bg-yellow-50 border border-yellow-200 p-2 rounded-xl mb-2">
      ...
      {showRejected && (
        <div className="bg-red-50 border border-red-200 p-2 rounded-xl mb-2">
      ...
      {!showPending && (
        <div className="space-y-6">
          ...
          <div className="border border-gray-200 rounded-xl p-2 bg-yellow-50 border-yellow-300">
            <h3 className="font-semibold mb-2 flex items-center gap-2">
...
function JobHistorySection({ userId }: { userId: string }) {
  ...
  if (history.length === 0) {
    return (
      <div className="border border-gray-200 rounded-xl p-2 md:p-2 mt-2">
        <h2 className="text-sm font-bold mb-2">📋 My Job History</h2>
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-2 md:p-2 mt-2">
      <h2 className="text-sm font-bold mb-2">📋 My Job History ({history.length} items)</h2>
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <main className="max-w-4xl mx-auto px-3 md:px-6 py-4 md:py-8">
        ...
        {isContractor && profile && (
          <div className="mb-8">
            {/* Stats */}
            <div className="grid grid-cols-2 gap-2 gap-2 mb-2">
              <div className="text-center p-2 md:p-2 bg-white rounded-xl md:rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="text-center p-2 border border-gray-200 rounded-xl">
        ...
        {/* Profile Details */}
        <div className="border border-gray-200 rounded-xl p-2 md:p-2">
          <h2 className="text-sm font-bold mb-2 text-[#0F172A]">Profile Details</h2>
        ...
        {isContractor && (
          <div className="border border-gray-200 rounded-xl p-2 md:p-2 mt-2">
            ...
            <p className="text-sm mb-2 opacity-70">Showcase your best work to homeowners.</p>
        ...
        {isContractor && (
          <div className="border border-gray-200 rounded-xl p-2 md:p-2 mt-2">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-sm font-bold">External Reviews</h2>
              <button
                onClick={() => {
                  if (!editingReviews) {
                  ...
                  <div className="space-y-2">
                    {profile.external_reviews.split('\n').filter(link => link.trim()).map((link, i) => (
                      <a 
                        ...
                        className="flex items-center gap-2 p-2 border border-gray-200 rounded-xl hover:bg-gray-50"
                      >
        ...
        <div className="mt-8 pb-8">
          <button
            ...
            className="w-full py-3 px-4 border border-red-200 text-red-600 rounded-xl font-medium hover:bg-red-50 transition-colors flex items-center justify-center gap-2"
          >
